...
<span class="post__more mono">Читать →</span>
    ...
    faqs = [
        ...
        ("Работаете только по Костанайской области?",
         "Нет. Завод стоит в селе Троебратское на трассе Костанай — Петропавловск, в самом селе есть ж/д станция Пресногорьковская. Отгружаем автотранспортом и вагонами по всему Казахстану — доставку в ваш регион организуем."),
