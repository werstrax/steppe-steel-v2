...
<ul class="eqlist">
<li class="eq reveal"><span class="eq__t">Автотранспорт</span><span class="eq__d">отгрузка комплектом прямо с площадки завода, доставку организуем</span></li>
...
{cta}""".format(
        ...
        hero=_hero("Доставка и монтаж",
                   "Довезём и&nbsp;соберём",
                   "Отгрузка автотранспортом и&nbsp;вагонами по&nbsp;всему Казахстану, монтаж со&nbsp;сдачей по&nbsp;акту. Контур здания — за&nbsp;{days}&nbsp;дней от&nbsp;договора.".format(days=SPECS["build_days"])),
        proc=proc,
    ...
    return page("dostavka-montazh.html",
                ...
                "Отгрузка автотранспортом и ж/д со станции Пресногорьковская, монтаж со сдачей по акту. Болтовая сборка без сварки, работы идут и зимой.",
